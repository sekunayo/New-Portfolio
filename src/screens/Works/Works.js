        ...
        <div className="works-box">
          ...
          <div className="absolute-svg">
            ...
            >
              ...
              <path d="M80 240L80 200H121L80 240Z" fill="#4ECDC4" />
              ...
              <path d="M243 80L243 40H283L243 80Z" fill="#4ECDC4" />
              <path d="M203 120L203 80H243L203 120Z" fill="#4ECDC4" />
              <path d="M163 161L163 121H203L163 161Z" fill="#4ECDC4" />
              <path d="M122 161L122 121H162L122 161Z" fill="#FF6B6B" />
              <path d="M203 80L203 40H243L203 80Z" fill="#FF6B6B" />
              <path d="M121 200L121 160H161L121 200Z" fill="#4ECDC4" />
              ...
              <path d="M243 241L283 241V201L243 241Z" fill="#4ECDC4" />
              <path d="M40 280L40 240H80L40 280Z" fill="#4ECDC4" />
              <path d="M203 281L244 281V240L203 281Z" fill="#4ECDC4" />
              <path d="M203 241L243 241V201L203 241Z" fill="#4ECDC4" />
